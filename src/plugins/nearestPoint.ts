...
import { ResolvedCoreOptions, ChartGLSeriesOptions } from "../options";
import { ChartGLPlugin } from ".";
import { RenderModel } from "../core/renderModel";

export class NearestPoint {
    private intersectPoints = new Map<ChartGLSeriesOptions, SVGGeometryElement>();
...
export const nearestPoint: ChartGLPlugin<NearestPoint> = {
    apply(chart) {
