...
import { resolveColorRGBA, ResolvedCoreOptions, ChartGLSeriesOptions, LineType } from '../options';
...
class SeriesVertexArray {
    ...
    constructor(
        private gl: WebGL2RenderingContext,
        private series: ChartGLSeriesOptions,
    ) {
    }
...
export class LineChartRenderer {
    ...
    private arrays = new Map<ChartGLSeriesOptions, SeriesVertexArray>();
    private height = 0;
    private width = 0;
...
export const lineChart: ChartGLPlugin<LineChartRenderer> = {
    apply(chart) {
